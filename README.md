...
Evaluate funding gaps and repayment behavior
Understand regional loan distribution and seasonal patterns
Provide actionable insights for improving portfolio performance
# Tools & Technologies Used
Excel – Data validation, pivot tables, and summary dashboards

SQL – Data cleaning, transformation, joins, and KPI calculations

Tableau – Interactive dashboards for visual exploration

Power BI – Executive-level dashboards with DAX and drill-down analysis
# Data Preparation
Merged multiple datasets using a common ID
...
Higher revolving balances observed in mid-to-lower credit grades
3. Verification Status Insights
Verified borrowers contribute more to total repayments
4. Regional Distribution
Loan activity varies across states, indicating geographic trends
...
Focus on risk management in lower credit grades
Introduce customer segmentation for targeted lending
Move towards real-time dashboards for monitoring
Include profitability analysis (interest vs default risk)
# Project Outcome
This project demonstrates how raw financial data can be transformed into meaningful insights using modern analytics tools. It helps stakeholders:
Reduce credit risk
...
Combined multiple datasets using common ID
...
Tableau → Exploratory dashboards
